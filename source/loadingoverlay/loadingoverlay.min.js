        ...
        if (!1 === a) {
            if (
                ...
                "<svg" === s.image.slice(0, 4).toLowerCase() &&
                    ...
                    (o.append(s.image),
                        o.children().css(c.element_svg), !s.imageClass && s.imageColor && o.find("*").css(s.imageColor)) :
                    ...
                    .done(function(e) {
                        o.html(e),
                            o.children().css(c.element_svg), !s.imageClass &&
                            s.imageColor &&
    ...
    function w(e) {
        return (!(!e || e < 0) &&
            ("string" == typeof e && -1 < ["vmin", "vmax"].indexOf(e.slice(-4)) ?
                ...
                "string" == typeof e &&
                -1 < ["px", "em", "cm", "mm", "in", "pt", "pc", "vh", "vw"].indexOf(
                    e.slice(-2)
                ) ?
